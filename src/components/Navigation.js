...
export default function Navigation() {
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-dark bg-opacity-25">
      <div className="ps-1 pe-0 container-fluid col-11 col-lg-8 col-xl-7 col-xxl-6 ">
        <ul className="navbar-nav me-0 mb-2 mb-lg-0 d-flex align-items-center justify-content-between pt-1">
          <li className="nav-item me-3 ms-1">
            <h1 className="h4">
              ...
              <br />- Infinite Scroll Version
            </h1>
          </li>
          <li className="nav-item me-3 ms-1 mt-2 text-muted">
            <p>
              Created by Ziyang Hu, using NASA's
              <br />
